...
class TestConsole(unittest.TestCase):
    ...
    def test_create(self):
        """Ths test create command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """This test destroy command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_update(self):
        """this test update command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_all(self):
        """This test alternate all command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_count(self):
        """This test count command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_show(self):
        """This test alternate show command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """this test alternate destroy command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
